<style lang="less" scoped>
  ...
  .test-button {
    .displayCenter(@align-items: flex-start);
...
<template>
  <div class="info-left">
    <div class="test-button">
      ...
      <input type="file" id="file1" style="position:absolute; clip:rect(0 0 0 0);" accept="image/png, image/jpeg, image/gif, image/jpg" @change="uploadImg($event, 1)">
      <div class="wrapper" v-if="Croppershow">
        <VueCropper ref="cropper" :img="example3.img" :autoCrop="example3.autoCrop" :autoCropWidth="example3.autoCropWidth" :autoCropHeight="example3.autoCropHeight" :fixedBox="example3.fixedBox" :canMove="example3.canMove"></VueCropper>
      </div>
